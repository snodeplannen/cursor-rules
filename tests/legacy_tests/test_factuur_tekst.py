#!/usr/bin/env python3
"""
Script om de factuurtekst "factuurn 6666" te verwerken.
"""
...
async def main():
    ...
    print("=== FACTUUR TEKST VERWERKING ===")
    ...
    try:
        ...
        result = await extract_structured_data(test_text, DocumentType.INVOICE)
